...
* The system has been built in Live+Gov EU project
* Analysis of Privacy aspects following a structured approach
* Derive eight privacy recommendations
* Some of them have been implemented in the service
...
* Privacy Protection very important topic in current time Fundamental
* Fundamental trade-off between enhanced functionality and convenience
  of the service (service demands) and personal data revealed by the
  use (privacy demands).
* Challenge for service provider. Find the right balance.
* We study concrete use case of a travel-survey application.
...
Travel surveys are regularly conducted by providers of public
transportation infrastructure in order to asses the current usage of
their services and inform future planning of e.g. bus or tram lines.
In this events a large number of citizens (e.g. 5000) is asked to keep
...
service. In this section we give a high level description of a generic
travel-survey service. This description along with the introduced
terminology will serve as a basis for our privacy analysis.

There are three stakeholders involved with the sysem: The
\emph{citizen}, the \emph{service provider} and the \emph{travel
  agency}. The service provider is the operator of all IT systems and
sells the travel-survey service to the travel agency.
