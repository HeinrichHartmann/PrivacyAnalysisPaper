...
The first step is the \emph{world view} where all components are described in their current state. It consists of the following components: \texttt{Assets}, \texttt{IT-Systems}, \texttt{Actors}, \texttt{Conflicts of Interests}, \texttt{Vulnerabilities}, and \texttt{Interactions}.

The relevant \texttt{IT-Systems} were already described in Section \ref{subsubsection:it-systems}.
\texttt{Interactions} between assets, IT-Systems, humans, and vulnerabilites as partly described in Section \ref{subsubsection:it-systems} and will be further analyzed in Section \ref{subsec:pot-analysis}.
