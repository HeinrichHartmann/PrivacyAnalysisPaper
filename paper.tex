...
\hline
& \thead{Privacy of the Person}
& \thead{Privacy of Behaviour and Action}
& \thead{Privacy of Communication}
& \thead{Privacy of Data and Image}
& \thead{Privacy of Thoughts and Feelings}
& \thead{Privacy of Location and Space}
& \thead{Privacy of Association}
\\\hline\hline
\thead{GPS Sensor}
& \tbody{0.5} % Privacy of the Person
& \tbody{0.5} % Privacy of Behaviour and Action
& \tbody{0} % Privacy of Communication
& \tbody{1} % Privacy of Data and Image
& \tbody{0.5} % Privacy of Thoughts and Feelings
& \tbody{1} % Privacy of Location and Space
& \tbody{0.5} % Privacy of Association
\\\hline
\thead{Motion Sensors}
& \tbody{1} % Privacy of the Person
& \tbody{0.5} % Privacy of Behaviour and Action
& \tbody{0} % Privacy of Communication
& \tbody{1} % Privacy of Data and Image
& \tbody{0} % Privacy of Thoughts and Feelings
& \tbody{0} % Privacy of Location and Space
& \tbody{0} % Privacy of Association
\\\hline
...
& \tbody{0.5} % Pricacy of Thoughts and Feelings
