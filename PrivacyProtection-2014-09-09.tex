...
The procedure describes a systematic way to analysis the IT system based on that model.
...
A description of the IT-Systems under study.
...
The \textbf{potential view} describes the intended and unintended interactions of the components of the world view.
...
Describes how IT-system and actors should interact in order to reach the goals of operation.
...
Targeted change in specify interactions that may not occure within the system in order to acieve its business objectives.
...
%TODO: (\textbf{Note:} This component is not conform to the glossary as the term \emph{accident} there covers both disaster and attack!)
...
The \textbf{event view} contains all actual events through out the lifetime of the system.
The event view instantiates the concept view of the system.
It contains the following components:
\begin{itemize}
\item
  \textbf{Business Process:} The actual, running instance of the business model.
\item
...
\textbf{Citizen:}
Citizens who take part in such urban monitoring systems share privacy sensitive data about themselves. 
They do it out of freewill and with consent to certain agreements on secrecy and proportionality.
So naturally they are interested in not having private information about them revealed to unknown third parties.
This would interfere with their ability to control such information, thus they cannot exercise privacy (according to Fried) anymore.

Beyond that, they share information with trust in the legitimate and proportional use of that information. 
Citizens expect their data is only used for public improvement within the agreed bounds.
They do not expect that their data is used for illegitimate purposes like scoring procedures, which could have a possible negative effect for them.

In general, Citizens are not interested in negative results for themselves.
This for financial loss. 
Local Authorities pay System Providers for their services.
Typically Local Authorities capitalize themselves via taxes.
So Citizens also have financial interests invested in the monitoring system.
...
\textbf{System Provider:} Lorem Ipsum

\textbf{Local Authority:} Lorem Ipsum

\textbf{Criminal:} Lorem Ipsum 
