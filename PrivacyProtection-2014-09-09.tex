...
%
%
\textbf{Surveillance} External infiltrates infrastructure in order to
obtain direct about the citizen. In this scenario the external is
supposed to have some direct relationship to the citizen which
motivates his interest to obtain personal information. Examples could
be a public institution that wants to gain information about planned
activities of the citizens (e.g. Nixon's Watergate scandal or the
recent prosecution of Guardian journalists by GHCQ). Another example
is an insurance company that seeks to get information about the
citizens life-style in relation to the insured risk, like car
...
Like an external person in Scenario (2) an employee of the service provider has selfish interests to gain money, make political statements or harm his employer.
...
An External can manipulate Local Authorities or Service Providers to
give them personal information that he can then sell or disclose.
...
%TODO:
Insert Table with Likeliness / Loss / Risk Assesment.

\subsubsection{Security Recommendations and Requirements}
...
\hline
\textbf{Threat} & \textbf{Likeliness} & \textbf{Loss} & \textbf{Risk} (Likeliness + Loss)
\\\hline
Insufficient Control Features & 4 (Always) & 1 (Low) & 5
\\\hline
Excessive Data Mining & 3 (High) & 2 (Medium) & 5
\\\hline
Data Theft & 1 (Low) / 2 (Medium) & 3 (High) & 4 / 5
\\\hline
Surveillance & 1 (Low) / 2 (Medium) & 3 (High) & 4 / 5
\\\hline
Information Leak & 1 (Low) & 3 (High) & 4
\\\hline
Social Engineering & 1 (Low) & 3 (High) & 4
\\\hline

\end{tabular}

\caption{Live+Gov Threat Evaluation}
\label{figure:Live+Gov Threat Evaluation}
\end{figure}
...
Processing Journal
\begin{itemize}
\item name of the controller
\item purpose of processing
\item description of the data categories
\item recipients of the data if disclosed
\item transfer to third countries
\item description of security of processing
\end{itemize}
