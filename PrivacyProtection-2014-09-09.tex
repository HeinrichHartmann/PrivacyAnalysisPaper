...
Although we use Fried's definition of privacy as one's control over information about oneself, we do not feel safe relying only on that to conduct a privacy protection analysis.
...
\end{itemize}
However, Friedewald et al. felt that Clarke's taxonomy are technologically outdated and no longer adequate.
...
\item 
\textbf{Privacy of Behaviour and Action}
...
\item 
\textbf{Privacy of Communication}
...
\item 
\textbf{Privacy of Thoughts and Feelings}
...
Also the additional actor \textit{Criminal} is introduced as an external person with harmful intentions.
...
\textbf{Criminal.}
Criminals are persons who do not have privileged access to the IT systems,
and are willing to break laws and norms in order to promote their interests.
...
Criminals could want to harm or destroy the systems in order to damage the reputation of local authorities (politicians or other officials) or to make a political statement of their own.
...
\textbf{System Complexity vs Privacy of the Citizen.}
System Providers offer a service to local authorities, which is to provide and maintain the IT system.
This system shall produce business intelligence, so that local authorities can improve their public services.
This task in it self has a high technical complexity and is the sole asset with financial return for system provider.
...
\textbf{Financial Profit of Criminal vs Privacy.}
...
\textbf{Financial Profit of Criminal vs Reputation of System Providers.}
...
Criminals can break the system to make a political statement of their own,
