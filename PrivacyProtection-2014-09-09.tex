...
Recall from the security model description in Section \ref{sec:GrimmModel}, that a threat is a potential interaction of the components that harms an asset.
...
In this section we describe, in a similar fashin, threats for the citizen privacy in the Live+Gov system.
