...
Again the amount 
 ...
 sends beneficial information (traffic jam reports, bus schedule) for \textit{Citizens} to the mobile device.
...
This includes just annoying spam, where their technical identity is used to send them unwanted commercials.
...
Local Authorities are public offices (ministry, agency, department, ...) which act as direct customers of Service Providers and order a proposed monitoring and mining system specialized for their needs. 
...
However, since a Local Authority is not a company, the return of investment is not solely of financial nature.
The main goal of monitoring and mining system is to reveal hidden information. 
So Local Authorities are heavily interested in business intelligence.
